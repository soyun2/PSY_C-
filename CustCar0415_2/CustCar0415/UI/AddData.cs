...
#pragma warning restore CS0108
        ...
        public AddData(UnionController uHandler)
        {
            ...
            ucAddCust.addCustConfirmEvent += addCustConfirmHandler;
            ucAddSell.addSellConfirmEvent += addSellConfirmHandler;
        }

        private void topylayer_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        {
            addDataStatus.Text = "고객 정보를 등록하였습니다.";
        }
        private void addSellConfirmHandler(object sender, EventArgs e)
        {
            addDataStatus.Text = "판매자 정보를 등록하였습니다.";
        }
        private void addDataDeal_Click(object sender, EventArgs e)
        {
            uHandler.ListUn.Add(new Deal<Car, Customer, Seller>(
                uHandler.CarHandle.ListCar[0], uHandler.CustHandle.ListCust[0], uHandler.SellHandle.ListSell[0],
                DateTime.Now.ToString("yyyy년MM월dd일")+DateTime.Now.ToString("HH:mm분:ss초"), uHandler.CarHandle.ListCar[0].Price));
        }
